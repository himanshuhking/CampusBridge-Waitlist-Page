...
const HERO_MENTOR = {
  ...
  sessions: 17,
  reviews: 12,
  quote: "Didn't clear the entrance exam on the first attempt, took a year to reapply",
};
...
const SECTION_MENTORS = [
  {
    ...
    flag: '🇮🇳',
    degree: '2nd Year, Computer Science',
    college: 'University of British Columbia',
    tags: [          { label: 'Visa process', bgColor: '#f0f6ff', textColor: '#27409e' },
      { label: 'Scholarships', bgColor: '#fef2f2', textColor: '#dc2626' },          { label: 'Campus life', bgColor: '#f0f6ff', textColor: '#27409e' },
    ],
    role: 'Research Assistant',
    sessions: 34,
    reviews: 22,
    quote: "Rejected twice before getting in — here's what changed",
  },
  {
    name: 'Marcus Chen',
    ...
    tags: [
      { label: 'Job placement', bgColor: '#f0f6ff', textColor: '#27409e' },
      { label: 'Cost of living', bgColor: '#f0f6ff', textColor: '#27409e' },
      { label: 'Part-time work', bgColor: '#fef2f2', textColor: '#dc2626' },
    ],
    role: 'Software Engineer at Shopify',
    sessions: 28,
    reviews: 18,
    quote: 'Chose McGill over a "ranked higher" school — no regrets',
  },
  {
    ...
    sessions: 19,
    reviews: 14,
    quote: 'Started at a local college, transferred after 1 year',
  },
];
      ...
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4 font-display">
            Stop guessing about your college decision from YouTube videos and brochures.
          </h1>
